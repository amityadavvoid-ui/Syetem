...
let activeParticles = [];
let isParticleLoopRunning = false; // ⚡ Optimization: Single loop flag

// ⚡ Optimization: Single RAF loop for all particles to reduce overhead
function updateParticlesLoop() {
  ...
  // Iterate backwards to safely remove finished particles
...
function spawnParticle() {
  ...
  // ⚡ Optimization: Store state object instead of using closure
  ...
  // ⚡ Optimization: Start the single loop if not running
