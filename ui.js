...
let activeParticles = []; // { element, startTime, duration, maxOpacity }
...
function spawnParticle() {
  ...
  // Push state object instead of just element
...
/*
   ...
   Replaced per-particle requestAnimationFrame loops with a single global loop.
   Reduces overhead from ~25 concurrent RAF callbacks to 1.
*/
