...
function spawnParticle() {
  ...
  // Store particle state to be updated by a centralized animation loop
  // instead of spawning a new requestAnimationFrame per DOM node.
...
// ⚡ Bolt: Centralized Animation Loop
// Reduces garbage collection and CPU overhead by batching DOM updates
...
function initParticleSystem() {
  ...
  // ⚡ Bolt: Start the single centralized animation loop
  requestAnimationFrame(updateParticlesLoop);
