...
function spawnParticle() {
  ...
  // ⚡ Bolt Performance: Push state object instead of DOM element
  // Centralizes animation loop to prevent GC overhead
...
// ⚡ Bolt Performance: Single loop for all particles
...
function initParticleSystem() {
  ...
  // ⚡ Bolt Performance: Start centralized loop once
  requestAnimationFrame(updateParticlesLoop);
